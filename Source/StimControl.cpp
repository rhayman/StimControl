							 ...
							 deviceSelected(false)
{
	...
	addStringParameter(Parameter::GLOBAL_SCOPE, "Duration", "Stimulation duration (ms)", "10");
	addStringParameter(Parameter::GLOBAL_SCOPE, "Interval", "Interval duration(ms)", "150");
